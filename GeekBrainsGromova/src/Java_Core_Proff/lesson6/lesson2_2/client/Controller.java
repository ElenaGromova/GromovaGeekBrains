package Java_Core_Proff.lesson6.lesson2_2.client;
...
public class Controller implements Initializable {
    ...
    @FXML
    TextField logFieldReg;

    @FXML
    TextField nickField;

    @FXML
    PasswordField passFieldReg;
            ...
            Thread thread = new Thread(() -> {
                try {
                    while (true) {
                        ...
                        System.out.println("str on client " + str);
...
//                                        }
    ...
    public void tryToReg() {
        ...
        try {
            out.writeUTF("/reg " + logFieldReg.getText() + " " + passFieldReg.getText() + " " + nickField.getText());
            System.out.println("отправка данных с формы регистрации " + "/reg " + logFieldReg.getText() + " " + passFieldReg.getText() + " " + nickField.getText());
            nickField.clear();
            logFieldReg.clear();
            passFieldReg.clear();
        } catch (IOException e) {

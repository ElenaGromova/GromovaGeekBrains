...
public class Hero extends GameCharacter {
    ...
    public void renderGUI(SpriteBatch batch, BitmapFont font) {
        ...
        strBuilder.append("Level: ").append(gc.getHero().getLevel()).append("\n");
        strBuilder.append("Experience: ").append(gc.getHero().getExperience()).append("\n");
        ...
        strBuilder.append("Damage: ").append(" [").append(weapon.getMinDamage() + (gc.getHero().getLevel() * 10)).append("-").append(weapon.getMaxDamage() + (gc.getHero().getLevel() * 10)).append("]\n");
    ...
    public boolean takeDamage(GameCharacter attacker, int amount) {
        // sound.play();
        gc.getInfoController().setupAnyAmount(position.x, position.y, Color.RED, "-", (amount + (attacker.getLevel() * 10)));
        return super.takeDamage(attacker, (amount + (attacker.getLevel() * 10)));
    }
